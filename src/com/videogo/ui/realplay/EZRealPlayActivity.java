...
//        client.disconnect();
    ...
    private void initTitleBar() {
        ...
        mLandscapeTitleBar = (TitleBar) findViewById(R.id.title_bar_landscape);//jingbo delete
...
//            mEZPlayer.startRecord("/sdcard/video.mp4");
    ...
    private void startRealPlay() {
        ...
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            // 提示没有连接网络
            setRealPlayFailUI(getString(R.string.realplay_play_fail_becauseof_network));//视频播放失败，请检查您的网络
            return;
        }
...
//                        return;
    ...
    private void setRealPlayLoadingUI() {
        ...
        if (mCameraInfo != null) {
            ...
            mRealPlayTalkBtn.setEnabled(false);//jingbo add
...
/*
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (v.getId()) {
//            case R.id.realplay_pages_gallery://jingbo delete
...
//                break;
    ...
    private StreamConvertCB.OutputDataCB mLocalRecordCb = new StreamConvertCB.OutputDataCB() {
        ...
        public void onOutputData(byte[] var1, int var2, int var3, byte[] var4) {
            if (mOs == null) {
                File dirF = new File("/sdcard/VideoGo/SsiotVideo/");
                if (!dirF.exists()){
                    dirF.mkdirs();
                }
                File f = new File("/sdcard/VideoGo/SsiotVideo/"+new Date().toLocaleString() + System.currentTimeMillis() + ".mp4");
                try {
