...
//                "b097e53bb9627e7e32b7a8001c701151", "token/accessToken/get", map);
        Map<String, Object> resultMap = paramsInit("53c5088dc4a84ecea79c379d6ef31646",
                "f03cd21e1edf6e62ff772674bc834b41", "token/getAccessToken", map);
        JSONObject signJson;
        try {
            signJson = setJosn(resultMap);
            return signJson.toString();
    ...
    public static String jingboGetSignStr(){
        String appKey = "53c5088dc4a84ecea79c379d6ef31646";
        String appSecret = "f03cd21e1edf6e62ff772674bc834b41";
        String method = "token/getAccessToken";
        
        Map<String, Object> paramsMap = new HashMap<String, Object>();
        {
            paramsMap.put("phone", "13951415610");
        }
        long time = System.currentTimeMillis() / 1000;
        StringBuilder paramString = new StringBuilder();
        if (paramsMap != null && !paramsMap.isEmpty()) {
