...
public class EditFertilizerAct extends HeadActivity{
    ...
    private void initTitleBar(){
        ...
        titleRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final ERPFertilizerModel model = new ERPFertilizerModel();
                model._id = 0;
                ...
                if (!TextUtils.isEmpty(model._name) && model._productbatchid > 0 && null != mTimeStamp){
                    new Thread(new Runnable() {
                        public void run() {
                            int ret = new ERPFertilizer().Save(model);
                            if (ret > 0){
                    ...
                    Toast.makeText(EditFertilizerAct.this, "请填写完整", Toast.LENGTH_SHORT).show();
                }
            }
        });
