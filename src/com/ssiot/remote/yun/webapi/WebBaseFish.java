...
public class WebBaseFish{
    private static final String tag = "WebBaseFFFFFFF-FISH";
    public static String URI_STATION = "http://db.fisher88.com:81/";//数据库（公网）114.55.145.45 内网1025.253.68 名fisher密码324#$th6s 数据库名fisher
