...
public class WebBasedb2{
    private static final String tag = "WebBasedb2";
    public static String URI_STATION = "http://db.ssiot.com:82/";//生产管理第二套api
    ...
    public String exeRetString(String methodFile, String method, HashMap<String, String> params) {
        ...
        if (object == null){
        	...
        	if (object.getPropertyCount() <= 0){
            	...
            	//返回anyType{}怎么处理 TODO
                Log.v(tag, "-------"+methodFile + " "+method+" webret----:" + txt);
