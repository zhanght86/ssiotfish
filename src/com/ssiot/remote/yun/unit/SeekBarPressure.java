...
public class SeekBarPressure extends View {
	...
	private String money[] = { "十分", "小时", "逐日", "逐月"};//, "逐年"
    /*
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d(TAG,mOffsetLow + 10-(mOffsetHigh + mThumbWidth-10)+"");
//        mScrollBarProgress.setBounds(mOffsetLow + 10 , 60 , mOffsetHigh + mThumbWidth-10, mThumbHeight+40);
//        mScrollBarProgress.draw(canvas);//jingbo delete this
...
//        mThumbHigh.draw(canvas);// jingbo delete this
